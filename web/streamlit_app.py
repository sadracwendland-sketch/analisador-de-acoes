...
from app.config import SUPPORTED_PERIODS  # type: ignore  # noqa: E402
from app.services.pipeline import run_full_analysis  # type: ignore  # noqa: E402
...
def inject_pwa_assets() -> None:
    ...
    icon_512 = "app/static/icon-512.png"
    worker_js = """
      const swCode = `
